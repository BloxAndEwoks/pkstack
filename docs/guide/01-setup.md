...
In a Claude Code session, add this repo as a plugin marketplace and install from it:

```text
/plugin marketplace add <owner>/pkstack
/plugin install pkstack@pkstack
```
...
[`/setup-pstack`](../../skills/setup-pstack/SKILL.md) detects the models you have access to, shows you each role (code delegates, judgment, the review panels), and asks what you want. Answer the questions. It writes `~/.claude/pkstack-models.md`, a small note every pstack skill reads.
