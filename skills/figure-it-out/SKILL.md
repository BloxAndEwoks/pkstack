...
- Write the designed phase list down. That list is what the human reviews. It carries, per unit, the unit's BASE and its close point. A bespoke playbook inherits map production and the close: the design step walks the ledger driver-side, and the fan-outs stay blind.
